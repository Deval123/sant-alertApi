...
$sql = "UPDATE ordonance SET  patients_id = '$newpatients_id', consultation_id = '$newconsultation_id', personelEts_id = '$newpersonelEts_id', 
   WHERE id ='$id';";
    ...
    if ($con->query($sql) === TRUE) {
        ...
        $response= "Error:". $sql . "<br>" . $con->error;///. $sql . “<br>” . $con->error;
    }
