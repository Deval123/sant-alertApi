...
$data = file_get_contents("php://input");
    if (isset($data)) {
        ...
        $personelEts_id = $request->newpersonelEts_id;
...
$sql = "UPDATE traitement SET  patients_id = '$newpatients_id', consultation_id = '$newconsultation_id', personelEts_id = '$newpersonelEts_id', 
   WHERE id ='$id';";
