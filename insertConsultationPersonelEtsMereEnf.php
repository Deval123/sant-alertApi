...
$data = file_get_contents("php://input");
    if (isset($data)) {
        ...
        $grossesses_id = $request->grossesses_id;
...
//'1', '6','chinois','24','2018-10-08 00:01:11'
    $sql = "INSERT INTO consultation (patients_id, hopital, nom_medecin, personelEts_id, datecreate, grossesses_id)
VALUES ('$patients_id', '$hopital', '$nom_medecin', '$personelEts_id', '$datecreate', '$grossesses_id')";
